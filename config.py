...
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "Hi, I am made by @MarvelitesSyndicate")
...
USE_SHORTLINK = False if os.environ.get('USE_SHORTLINK', "False") == "TRUE" else False 
